%Original Max Value
MaxVal = -1.244996007458183e+10;

%Amount added to value
Delta = 1;

%Add Delta to one of these values
TLA = [274225.71+Delta 31220.11 217188.03 3710.34];
...
%Tons per Hectare and Price per Ton
T = [4.9233 3.3403 4.3957 2.8509];
P = [15835 16007 16106 16377 16519 16449 16401 16353 15700 14800 14644 14812;
    13299 13604 13703 13941 14083 14150 14295 14318 14429 14206 14361 14442;
    13519 14348 14600 14956 15044 14959 15016 14903 14485 14105 14287 14300];

G = [T(1)*P(1,1) T(1)*P(1,2) T(1)*P(1,3) T(1)*P(1,4) T(1)*P(1,5) T(1)*P(1,6) T(1)*P(1,7) T(1)*P(1,8) T(1)*P(1,9) T(1)*P(1,10) T(1)*P(1,11) T(1)*P(1,12);
    T(2)*P(1,1) T(2)*P(1,2) T(2)*P(1,3) T(2)*P(1,4) T(2)*P(1,5) T(2)*P(1,6) T(2)*P(1,7) T(2)*P(1,8) T(2)*P(1,9) T(2)*P(1,10) T(2)*P(1,11) T(2)*P(1,12)
    T(3)*P(2,1) T(3)*P(2,2) T(3)*P(2,3) T(3)*P(2,4) T(3)*P(2,5) T(3)*P(2,6) T(3)*P(2,7) T(3)*P(2,8) T(3)*P(2,9) T(3)*P(2,10) T(3)*P(2,11) T(3)*P(2,12)
    T(4)*P(3,1) T(4)*P(3,2) T(4)*P(3,3) T(4)*P(3,4) T(4)*P(3,5) T(4)*P(3,6) T(4)*P(3,7) T(4)*P(3,8) T(4)*P(3,9) T(4)*P(3,10) T(4)*P(3,11) T(4)*P(3,12)];
